...
private extension String {
    ...
    var isSanitaryWidgetLine: Bool {
        ...
        if [
            ...
            "Диалог с ИИ",
            "Диалог с ИИ: читает",
            "Диалог с ИИ: читает ответ",
            "Диалог с ИИ: отвлекся от экрана",
            "Веб-контекст: просматривает страницу",
            "Веб-контекст: читает",
            "Веб-контекст: переключает вкладки",
            "Веб-контекст: отвлекся от экрана",
            "Коммуникация: отвечает",
            "Коммуникация: читает",
            "Коммуникация",
            "Соцсети: просматривает ленту",
            "Сервисная настройка",
            "Рабочий контекст: активные действия",
            "Рабочий контекст",
            "Дизайн: правит макет",
            "Дизайн: читает",
            "Дизайн: отвлекся от экрана",
            "Код: активная правка",
            "Встреча: активное участие",
            "Поиск / сравнение: много переключений",
            "Энергия просела: зевок в текущем контексте",
            ...
            "Фрикция: возвращается к тому же месту",
            "Наблюдаю контекст"
        ].contains(normalized) {
            return true
        }
